            ...
            <div class="col-md-3">
                <section class="ingresar">
                    ...
                    <div class="form-group">
                        ...
                        <input type="username" class="form-control" id="" aria-describedby=""
                    ...
                    <a type="submit" href="/integradora/estudiante/perfil" class="btn btn-primary">Ingresar</a>
                    <br>
                    <br>
                    <a class="reg" href="/integradora/estudiante/registrar">Registrate</a>
                    <br>
                    <br>
                <a class="contra" href="html/recuperaral.html">¿Olvidaste tu usuario <br>o contraseña?</a>
                </section>
